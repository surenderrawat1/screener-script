...
/** KIMS top hit @ 817.15 EOD 2026-07-07 (Nifty 500 SETUP+ scan). */
...
describe('parity — KIMS universe scan row', () => {
  it('computeTradePlan uses frozen 3R target (no momentum boost)', () => {
    ...
    expect(plan.profit_target).toBeCloseTo(884.56, 1);
