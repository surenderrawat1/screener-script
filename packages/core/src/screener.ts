...
const SAMPLE_METRICS: Record<string, Partial<StockMetrics>> = {
  ...
  SBIN: {
    ...
    sector: 'Banking',
    industry: 'Banking / Financial Services',
    market_cap_cr: 905000,
    div_yield: 1.6,
    promoter_holding: 57.4,
  },
  ITC: {
    name: 'ITC',
    price: 420,
